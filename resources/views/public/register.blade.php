            ...
            <div class="offcanvas-body">
                <div class="offcanvas-form">
                    <div class="login-head">
                        <h4 class="title">Your are 1 step closer to your order</h4>
                    ...
                    <form method="post" action="">
                        ...
                        <button name="register" value="submit" type="submit" class="btn btn-primary w-100 d-block">
                            Sign Up
                        </button>
                    </form>
                    ...
                    <p class="text-center m-t30">
                        ...
                        <a class="register text-primary font-weight-500" data-bs-toggle="" href="{{ route('user.login') }}"
                            role="button" aria-controls="offcanvasRegister">Login
                            here</a>
                    </p>
                </div>
            </div>
